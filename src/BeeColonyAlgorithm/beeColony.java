...
public class beeColony
{
	...
	int limit = 18;  /*A food source which could not be improved through "limit" trials is abandoned by its employed bee*/
	int maxCycle = 2500; /*The number of cycles for foraging {a stopping criteria}*/

	/* Problem specific variables*/
	int D = 18; /*The number of parameters of the problem to be optimized*/
...
//	FunctionCallback function = &sphere;
	...
	void SendOnlookerBees(ArrayList<FutbolTakimlari> teams)
	{
